<template>
  <footer class="footer">
    <div class="container content">
      <div class="columns">
        <div class="column">
          <p class="fix-bottom">{{ copyRight }}</p>
        </div>
        <div class="column">
          <img
            class="logo fix-bottom center"
        ...
        <div class="column">
          <div class="fix-bottom fix-right">
            <ul>
              <li
                v-for="icon in socialMediaConfig.iconInfo"
                :key="icon.name"
              >
                <a
                  :href="icon.url"
