<template>
  <section id="resume">
    <resume-overview :personal="personal"/>
    <resume-skills :skills="personal.skills"/>
    <resume-history :personal="personal"/>
    ...
    data(){
        return {
            personal: {
                ...
                phone: '(480) 747-0781',
                phoneRef: 'tel:+01-480-747-0781',
                web: 'hashrebel.com',
                webRef: 'https://hashrebel.com',
